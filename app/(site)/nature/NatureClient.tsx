...
interface NatureClientProps {
    initialNatureData: any;
}
            ...
            <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
                    ...
                    >
                        ...
                        <RenderText
                            content={natureData?.hero?.description}
                            className="text-white/80 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed drop-shadow-lg"
                            fallback="Là où la terre s'efface devant la mer. Un sanctuaire de dunes et d'estuaire, sauvage et préservé."
                        />
                    </motion.div>
                </div>
                ...
                <div className="container mx-auto px-6 max-w-[1300px]">
                    <div className="flex flex-col md:flex-row gap-16 items-start">
                        ...
                        <div className="md:w-1/3 sticky top-32">
                            ...
                            <RenderText
                                content={natureData?.estran?.description}
                                className="text-base text-slate-600 leading-relaxed font-medium mb-10"
                                fallback="Coutainville est le théâtre de l'un des plus grands marnages du monde. Comprendre ce mouvement perpétuel est la première étape de l'observation."
                            />
                            ...
                            >
                                ...
                                <div className="px-1 pb-1">
                                    ...
                                    <div className="text-[9px] text-slate-400 font-bold uppercase tracking-wide mb-3 flex flex-wrap gap-2">
                                        {specie.tags?.map((tag: any, tIdx: number) => (
