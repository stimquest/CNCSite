...
export async function GET() {
    try {
        ...
        const weatherUrl = `https://api.open-meteo.com/v1/forecast?latitude=${LAT}&longitude=${LON}&daily=sunrise,sunset,weather_code&hourly=temperature_2m,wind_gusts_10m,wind_speed_10m,wind_direction_10m,precipitation_probability&models=arome_france_hd&minutely_15=temperature_2m,relative_humidity_2m,precipitation,precipitation_probability,wind_speed_10m,wind_direction_10m,wind_gusts_10m&timezone=auto&forecast_days=3&wind_speed_unit=kn`;
